    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Remove Batches</h4>
        </div>

        <form role="form" action="<?php echo base_url('batch/remove') ?>" method="post" id="removeForm">
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    manageTable = $('#manageTable').DataTable({
      'ajax': base_url + 'batch/fetchProductData',
      'order': [],
      buttons: [
