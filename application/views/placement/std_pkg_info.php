        ...
        <div class="box">
          ...
          <div class="box-body">
            ...
            <?php foreach ($h as $k => $r) {
              ...
              <div class="form-group">
                <label for="company_name">Courses</label>
                <input type="text" class="form-control" id="student_name" name="student_name"
                  value="<?php echo $courses ?>" autocomplete="off" readonly>
              </div>
              <div class="form-group">
                <label for="company_name">Batches</label>
                <input type="text" class="form-control" id="student_name" name="student_name"
                  value="<?php echo $package_name ?>" autocomplete="off" readonly>
              </div>
              <div class="form-group">
