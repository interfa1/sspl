 ...
 * Created: 2024-04-17 13:10:41
 Last Modification Date: 2024-04-22 14:31:58
 *
 **/
?>
                    ...
                    <div class="box-header">
                        <div style="display:flex;align-items:center;justify-content:space-between;gap:10px;">
                            <h3 class="box-title" style="text-transform:capitalize">
                                <b><?php echo $studentData['firstname'] . " " . $studentData['lastname']; ?></b>
                                Attendance
                            </h3>
                        </div>
                ...
                <div class="modal-body">
                    <form onsubmit="updateForm(this);return false;" method="post" id="udpateAttendanceForm">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="batch_id" id="batch_id" type="text" class="form-control" readonly required>
                                <?php
                                foreach ($batchs as $v) { ?>
...
<script>
    ...
    function loadEvents() {
        $.ajax({
            url: "<?php echo base_url(); ?>attendance/getStuddentAttendanceEvents/<?php echo $userId; ?>/<?php echo $batchId; ?>",
            type: "post",
            data: {},
            dataType: 'json',
            success: function (d) {
