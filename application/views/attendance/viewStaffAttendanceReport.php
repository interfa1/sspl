 ...
 * Created: 2024-04-17 13:10:41
 Last Modification Date: 2024-04-22 14:31:55
 *
 **/
                    ...
                    <div
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td>Staff Name:</td>
                                    <td><b><?php echo $staffData['firstname'] . " " . $staffData['lastname']; ?></b>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Total Days:</td>
...
<script>
    ...
    $(document).ready(function () {
        ...
        loadEvents(frm.start.value, frm.end.value);
    });

    function filterAttendance(form) {
        loadEvents(form.start.value, form.end.value);
    }
    ...
    function loadEvents(start, end) {
        $.ajax({
            ...
            type: "post",
            data: { "start": start, "end": end, "uid": "<?php echo $userId; ?>" },
            dataType: 'json',
            success: function (d) {
                if (d.data != null) {
