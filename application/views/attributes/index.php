  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Add Shedule</button>
        <br /> <br />
        <?php //endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Manage Shedule</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
      ...
      <form role="form" action="<?php echo base_url('attributes/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Shedule Name</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
            aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Edit Shedule</h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('attributes/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name">Shedule Name</label>
            <input type="text" class="form-control" id="edit_attribute_name" name="edit_attribute_name"
              placeholder="Enter attribute name" autocomplete="off">
          </div>
          <div class="form-group">
