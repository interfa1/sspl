...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    manageTable = $('#manageTable').DataTable({
      responsive: true,
      'ajax': base_url + 'jobs/fetchJobsDataByBranchAndStatus/<?php echo $branchId . "/" . $statusCode ?>',
      scrollY: true,
autoWidth: false,
      "scrollX": true,
      dom: 'Bfrtip',
  ...
  function reloadWithFilter(statusType) {
    if (statusType == "all")
      manageTable.ajax.url(base_url + 'jobs/fetchJobsDataByBranchAndStatus/<?php echo $branchId . "/" . $statusCode ?>').load();
    else
      manageTable.ajax.url(base_url + 'jobs/fetchJobsDataByBranchAndStatus/<?php echo $branchId ?>/' + statusType).load();
  }
