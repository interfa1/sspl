        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="product_name">Course name</label>
                <input type="text" class="form-control" id="product_name" name="product_name"
                  placeholder="Enter product name" value="<?php echo $product_data['name']; ?>" autocomplete="off" />
                <input type="hidden" class="form-control" id="sku" name="sku" placeholder="Enter IMEI/Device Reg. No."
                  value="0" autocomplete="off" />
                <input type="hidden" class="form-control" id="timing" name="timing" value="0" autocomplete="off" />
                <input type="hidden" class="form-control" id="price" name="price" value="0" autocomplete="off" />
                <input type="hidden" class="form-control" id="qty" name="qty" placeholder="Enter Qty" value="0"
                  autocomplete="off" />
              ...
              <!-- <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="sku" name="sku" placeholder="Enter IMEI/Device Reg. No." value="<?php echo $product_data['sku']; ?>" autocomplete="off" />
                </div> -->

              <!-- <div class="form-group">
                  <label for="sku">Timing</label>
                  <input type="text" class="form-control" id="timing" name="timing" value="<?php echo $product_data['timing']; ?>" autocomplete="off" />
                </div>
           -->

              <!-- <div class="form-group">
                  <label for="price">Price</label>
                  <input type="text" class="form-control" id="price" name="price" value="<?php echo $product_data['price']; ?>" autocomplete="off" />
                </div> -->
              <!-- 
                <div class="form-group">
