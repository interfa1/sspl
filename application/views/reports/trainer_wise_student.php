...
* Created: 2024-03-30 19:58:34
 Last Modification Date: 2024-05-24 18:10:25
*
**/
?>
        ...
        <div class="box">
            <div class="box-header">
                ...
                <div style="display:flex;align-items:center;justify-content:space-between;gap:10px;">
                    <h3 class="box-title">Trainerwise Students</h3>
                    <div>
                        <select class="form-control" id="trainerSelector" onchange="loadStudents(this)">
                            <?php
                            if (sizeof($trainers) > 0) {
                                foreach ($trainers as $b) {
                                    echo '<option value="' . $b['id'] . '">' . $b['firstname'] .' '. $b['lastname'] . '</option>';
                                }
                            } else {
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        manageTable = $('#manageTable').DataTable({
            'ajax': base_url + 'reports/fetchTrainerwisedata/' + $("#trainerSelector").val(),
            scrollY: true,
            autoWidth: false,
            "scrollX": true,
            dom: 'Bfrtip',
    ...
    function loadStudents(me) {
        manageTable.ajax.url("<?php echo base_url('reports/fetchTrainerwisedata/') ?>" + me.value).load();
    }
