...
* Created: 2024-03-30 19:58:34
 Last Modification Date: 2024-05-28 21:29:17
*
**/
?>
        ...
        <div class="box">
            <div class="box-header">
                ...
                <div style="display:flex;align-items:center;justify-content:space-between;gap:10px;">
                    <h3 class="box-title">All Active Students</h3>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        manageTable = $('#manageTable').DataTable({
            'ajax': base_url + 'reports/fetchTotalActiveStudents',
            scrollY: true,
            autoWidth: false,
            "scrollX": true,
            dom: 'Bfrtip',
     ...
     */
    function loadData() {
        manageTable.ajax.url("<?php echo base_url('reports/fetchTotalActiveStudents/') ?>");
    }
