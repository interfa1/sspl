    ...
    <div class="row">
      <!-- <div class="row">
         <div class="inter">
               ...
               <div class="col-md-4">
                 <input type="button" name="Search" class="btn btn-info primary"/>
               </div>  
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <?php if (in_array('createOrder', $user_permission)): ?>
          <a href="<?php echo base_url('orders/create') ?>" class="btn btn-primary">Add Enrollment</a>
          <br /> <br />
        <?php endif; ?>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    manageTable = $('#manageTable').DataTable({
      'ajax': base_url + 'orders/todaylist_wagholi',
      'order': [],
      scrollY: true,
autoWidth: false,
      "scrollX": false,
    ...
    //       "order": [],
    //       "ajax":{
    //          url: base_url + 'orders/fetch_datewise',
    //          type:'POST',
    //          data:{
