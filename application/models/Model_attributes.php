...
class Model_attributes extends CI_Model
{
	...
	{
		$sql = "SELECT * FROM attributes WHERE active  = ? order by id desc";
	...
	{
		if ($id) {
			$sql = "SELECT * FROM attributes where id  = ? order by id desc";
	...
	{
		if ($id) {
			$sql = "SELECT * FROM attribute_value WHERE attribute_parent_id  = ? order by id desc";
			$query = $this->db->query($sql, array($id));
	...
	{
		$sql = "SELECT * FROM attribute_value WHERE id  = ? order by id desc";
		$query = $this->db->query($sql, array($id));
		return $query->row_array();
	}
